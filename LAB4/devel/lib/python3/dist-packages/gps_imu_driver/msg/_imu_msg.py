...
"""autogenerated by genpy from gps_imu_driver/imu_msg.msg. Do not edit."""
import codecs
import sys
...
class imu_msg(genpy.Message):
  _md5sum = "00ccca0a92f0ac88045addd61ca8c562"
  _type = "gps_imu_driver/imu_msg"
...
MSG: sensor_msgs/MagneticField
 ...
 float64[9] magnetic_field_covariance # Row major about x, y, z axes
  ...
  __slots__ = ['Header','IMU','MagField','IMU_backup']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       Header,IMU,MagField,IMU_backup
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.IMU_backup = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.IMU_backup = str[start:end]
      return self
